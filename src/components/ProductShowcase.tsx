      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-16">
          <h2 className="font-display text-6xl mb-4 md:mb-0">
            SHOP <span className="text-modkicks-red">COLLECTION</span>
          </h2>
        ...
        <div className="text-center mb-10">
          <h2 className="font-display text-4xl md:text-5xl">
            FEATURED <span className="text-modkicks-red">PRODUCTS</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {featuredProducts.map((product, index) => (
            <div
              key={index}
              className="product-card group relative bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300"
            >
              <div className="aspect-square bg-gradient-to-br from-modkicks-lightgray to-white rounded-t-xl overflow-hidden">
                ...
                <div className="absolute top-0 right-0 p-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button className="bg-white rounded-full w-8 h-8 flex items-center justify-center shadow-md hover:bg-modkicks-red transition-colors">
                    <svg
              ...
              <div className="p-4">
                <div className="flex justify-between items-start mb-1">
                  <h3 className="font-medium text-lg group-hover:text-modkicks-red transition-colors">
                    {product.name}
                  </h3>
                  <span className="font-bold text-modkicks-black">
                    {product.price}
                  </span>
                </div>
                {product.isCustomizable && (
                  <div className="mb-3">
                    <span className="inline-block bg-modkicks-red/20 text-modkicks-black text-xs px-3 py-1 rounded-full font-medium border border-modkicks-red/30">
                      Customizable
                    </span>
                  </div>
                )}
