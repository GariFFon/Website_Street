  ...
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-16">
          <h2 className="font-display text-6xl mb-4 md:mb-0 text-white">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-16">
          {categories.map((category, index) => (
            <div
              key={index} className="group relative overflow-hidden rounded-xl aspect-square cursor-pointer border border-zinc-800 hover:border-zinc-600 transition-all duration-500"
            >
              <img
                src={category.image}
                alt={category.title}
          ...
          >
            <CarouselContent>
              {featuredProducts.map((product, index) => (
                ...
                <div className="product-card group relative bg-zinc-900 rounded-xl overflow-hidden border border-zinc-800 hover:border-zinc-600 transition-all duration-300 h-full mx-2">
                  ...
                  <div className="p-4">
                    ...
                    <div className="mt-3 transform translate-y-2  group-hover:translate-y-0 transition-all duration-300">                        
                      <Button
                        variant="outline"
